...
._v3_redisplay_menu;
	...
	for (::) {
		print "^Wùhle 1 zu ", lines, " oder ENTER um die Optionen erneut anzuzeigen.^";
		print "> ";
...
Constant NKEY__TX       = "N = nùchstes Thema";
Constant PKEY__TX       = "P = vorherig";
Constant QKEY1__TX      = "  Q = Spiel fortsetzen";
Constant QKEY2__TX      = "Q = vorheriges Menù";
